...
{
    /// <summary>
    /// MySql 数据库实现参数化操作的上下文对象类。
    /// </summary>
    internal class ParameterContext : IParameterContext
    {
        private readonly Type _StringType = typeof(string);
        private Dictionary<object, MySqlParameter> _Params = new Dictionary<object, MySqlParameter>();
        ...
        public string Add(object value)
        {
            ...
            if (EnableParametric)
            {
                if (_Params.TryGetValue(value, out MySqlParameter parameter))
                {
                ...
                else
                {
                    ...
                    _Params.Add(value, new MySqlParameter($"P{index}", value));
