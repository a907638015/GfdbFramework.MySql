...
using GfdbFramework.MySql.Test.Entities;

namespace GfdbFramework.MySql.Test
{
    /// <summary>
    /// 数据操作上下文对象类。
    /// </summary>
    public class DataContext : MySql.DataContext
    {
        ...
        /// </summary>
        public DataContext()
            : base("8.0.32", "Server=localhost;Database=TestDB;Uid=root;Pwd=root")
        {
